...
def bot():
    ...
    if "recruiting" in incoming_msg:
        ...
        responded = True
    if not responded:
        msg.body('Hi wisdom lite offers a few features, to get information about recruiting, text "recruiting", to learn about ventures, text "ventures", to get life advice from time-tested books, and relevant innovators text "subscribe", and if youre particularly risky, text " im cooking". Enjoy')
    return str(resp)
